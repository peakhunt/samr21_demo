...
{
	RF_SPI_CLOCK_init();
	spi_m_sync_init(&RF_SPI, SERCOM4);
	RF_SPI_PORT_init();
}
...
void system_init(void)
{
	...
	gpio_set_pin_direction(RF_SLP_TR,
	                       // <y> Pin direction
	                       // <id> pad_direction
	                       // <GPIO_DIRECTION_OFF"> Off
	                       // <GPIO_DIRECTION_IN"> In
	...
	gpio_set_pin_pull_mode(RF_SLP_TR,
	                       // <y> Pull configuration
	                       // <id> pad_pull_config
	                       // <GPIO_PULL_OFF"> Off
	                       // <GPIO_PULL_UP"> Pull-up
	...
	gpio_set_pin_function(RF_SLP_TR,
	                      // <y> Pin function
	                      // <id> pad_function
	                      // <i> Auto : use driver pinmux if signal is imported by driver, else turn off function
	...
	gpio_set_pin_direction(RF_RSTN,
	                       // <y> Pin direction
	                       // <id> pad_direction
	                       // <GPIO_DIRECTION_OFF"> Off
	                       // <GPIO_DIRECTION_IN"> In
	...
	gpio_set_pin_pull_mode(RF_RSTN,
	                       // <y> Pull configuration
	                       // <id> pad_pull_config
	                       // <GPIO_PULL_OFF"> Off
	                       // <GPIO_PULL_UP"> Pull-up
