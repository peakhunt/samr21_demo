...
static void
dummy_enter_critical(CircBuffer* cb)
{
  (void)cb;
}

static void
dummy_leave_critical(CircBuffer* cb)
{
  (void)cb;
}
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    circ_buf_leave_critical leave_critical)
{
  ...
  {
    cb->enter_critical = dummy_enter_critical;
  }

  if(leave_critical != NULL)
  {
    cb->leave_critical = leave_critical;
  }
  else
  {
    cb->leave_critical = dummy_leave_critical;
  }
}
